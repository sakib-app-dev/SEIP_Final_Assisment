          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="#"><i class="fa fa-angle-right"></i> Users List</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li>
                  <a href="{{ route('product.index') }}">
                    <i class="fa fa-angle-right"></i> List of Products</a></li>
                <li>
                  <a href="{{ route('product.create') }}">
                    <i class="fa fa-angle-right"></i> Create Products</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="charts.html">
